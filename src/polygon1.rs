...
impl Polygon for Framebuffer {
    fn polygon(&mut self, points: &[(usize, usize)]) {
        ...
        for i in 0..points.len() {
            ...
            self.line(Vec3::new(x0 as f32, y0 as f32, 0.0), Vec3::new(x1 as f32, y1 as f32, 0.0));
    ...
    fn filled_polygon(&mut self, points: &Vec<Vec3>){
        ...
        for y in min_y..=max_y{
            ...
            //fin intersection points with scanline
            for i in 0..points.len(){
                let p1 = points[i];
            ...
            //Sort intersection points x
            intersections.sort_by(|a,b| a.partial_cmp(b).unwrap());

            //Fill spans between pairs of intersection points
                ...
                if i + 1 < intersections.len(){
                    ...
                    for x in x1..=x2{
                        ...
                        if x == x1 || x == x2 {
                            ...
                            self.point(x, y);
                            self.set_current_color(0x00FFFF); //cambio de color
                        }
                    }
                }
            }
